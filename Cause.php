                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_cause">
                        ...
                        <div class="causes_content">
                            ...
                            <a href="cause_details.php"><h4>Help us to Send Food</h4></a>
                            <p>The passage is attributed to an 
                                unknown typesetter in the century 
                                who is thought</p>
                            <a class="read_more" href="cause_details.php">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_cause">
                        ...
                        <div class="causes_content">
                            ...
                            <a href="cause_details.php"> <h4>Clothes For Everyone</h4></a>
                            <p>The passage is attributed to an 
                                unknown typesetter in the century 
                                who is thought</p>
                            <a class="read_more" href="cause_details.php">Read More</a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_cause">
                        ...
                        <div class="causes_content">
                            ...
                            <a href="cause_details.php"> <h4>Water For All Children</h4></a>
